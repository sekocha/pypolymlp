...
from pypolymlp.mlp_gen.generator import run_generator_single_dataset
from pypolymlp.mlp_gen.multi_datasets.additive.generator import run_generator_additive
from pypolymlp.mlp_gen.multi_datasets.additive.generator_sequential import (
    run_sequential_generator_additive,
)
from pypolymlp.mlp_gen.multi_datasets.generator import run_generator_multiple_datasets
...
def run():
    ...
    if args.infile is not None:
        if args.features is False and args.precision is False:
        ...
        if len(args.infile) == 1:
            ...
            if params_dict["dataset_type"] == "phono3py":
                ...
                run_generator_single_dataset(
                    infile, compute_learning_curve=args.learning_curve
                )
            else:
                if args.sequential:
                    ...
                    run_generator_single_dataset(infile, compute_learning_curve=True)
                else:
                    print("Mode: Regression")
