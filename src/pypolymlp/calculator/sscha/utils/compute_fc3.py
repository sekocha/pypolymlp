...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--yaml', type=str, default='sscha_results.yaml',
        help='sscha_results.yaml file to be parsed.'
    )
    parser.add_argument(
        '--fc2', type=str, default='fc2.hdf5',
        help='fc2.hdf5 file to be parsed.'
    )
    parser.add_argument(
        '--pot', nargs='*', type=str, default=None,
        help='polymlp.lammps file'
    )
    parser.add_argument(
        '-n', '--n_samples', type=int, default=10000,
    ...
    polyfc.run(
        disps=ph_real.displacements, 
        forces=ph_real.forces, 
        write_fc=False
    )
