...
if __name__ == '__main__':
    ...
    if args.structure == 'bcc':
        ...
        path = [[[0,0,0],[0.5,-0.5,0.5],[0.25,0.25,0.25],[0,0,0],[0,0.0,0.5]]]
        labels = ["G","H","P","G","N"]
    elif args.structure == 'fcc':
        primitive = [[0.5,0,0.5], [0.5,0.5,0], [0,0.5,0.5]]
        path = [[[0,0,0],[0.5,0.5,0]],
                 [[0.5,0.5,1], [0.375,0.375,0.75],[0,0,0],[0.5,0.5,0.5]]]
        labels = ["G","X","K","G","L"]
    elif args.structure == 'rocksalt':
        primitive = [[0.5,0,0.5], [0.5,0.5,0], [0,0.5,0.5]]
        path = [[[0.5,0.5,0], [0,0,0]],
                 [[0,0,0],[0.5,0.5,0.5]]]
        labels = ["X","G","L"]
