...
def save_sscha_yaml(sscha, args, filename='sscha_results.yaml'):
    ...
    print('', file=f)
    print_array1d(logs['harmonic_potential'], 
                  'harmonic_potential', f, indent_l=2)
    print('', file=f)
    print_array1d(logs['average_potential'], 
                  'average_potential', f, indent_l=2)
    print('', file=f)
    print_array1d(logs['anharmonic_free_energy'], 
                   'anharmonic_free_energy', f, indent_l=2)
    print('', file=f)
