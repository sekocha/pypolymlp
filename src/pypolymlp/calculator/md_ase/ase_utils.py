...
def convert_phonopy_atoms_to_ase_atoms(phonopy_atoms: PhonopyAtoms) -> Atoms:
...
def convert_ase_atoms_to_phonopy_atoms(ase_atoms: Atoms) -> PhonopyAtoms:
...
def convert_polymlp_structure_to_ase_atoms(structure: PolymlpStructure) -> Atoms:
...
def convert_ase_atoms_to_polymlp_structure(ase_atoms: Atoms) -> PolymlpStructure:
