...
def compute_formation_energies(
    ...
    if energies is not None:
        ...
        energies, _, _ = properties.eval_multiple(structures)

    compositions = _initialize_composition(
        end_structures=end_structures,
        end_energies=end_energies,
        elements=elements,
        properties=properties,
    )
    n_atoms_array = _get_n_atoms(structures, elements=elements)
    form = compositions.compute_formation_energies(energies, n_atoms_array)
    return form
