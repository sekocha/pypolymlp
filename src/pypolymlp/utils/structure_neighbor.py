...
def __find_trans(axis, cutoff):
    ...
    trans2 = set([tuple(c + np.array(tr)) for c in trans[:,ids].T 
...
if __name__ == '__main__':
    ...
    parser.add_argument('-p', '--poscars', 
                        ...
                        default=None,
                        help='poscar files')
    parser.add_argument('-v', '--vaspruns', 
                        nargs='*',
                        type=str, 
                        default=None,
                        help='vasprun files')
    parser.add_argument('--cutoff', 
                        ...
                        default=None,
                        help='cutoff radius')
    parser.add_argument('--cutoff_ratio', 
                        type=float, 
                        default=None,
    ...
    for st_dict, id1 in zip(st_dict_array, ids):
        if args.cutoff_ratio is not None:
            ...
            neigh_dict = compute_neighbor_list(st_dict, 
                                               min_dis * args.cutoff_ratio)
        else:
